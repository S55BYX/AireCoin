    ...
    return (
        <div className="docs-container">
            <div className="docs-main">
                ...
                <p>To interact with a Aire cluster, we will use its command-line interface, also known as the CLI. We use the command-line because it is the first place the AireCoin core team deploys new functionality. The command-line interface is not necessarily the easiest to use, but it provides the most direct, flexible, and secure access to your Solana accounts.</p>
